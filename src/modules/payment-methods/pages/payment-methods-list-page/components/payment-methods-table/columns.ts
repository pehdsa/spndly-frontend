...
import PaymentMethodActions from './PaymentMethodActions.vue'
...
export const columns: ColumnDef<PaymentMethod>[] = [
  ...
  },
  {
    ...
    enableSorting: false,
    cell: ({ row }) =>
      h('div', { class: 'flex justify-center items-center' }, h(PaymentMethodActions, { paymentMethod: row.original })),
  },
]
